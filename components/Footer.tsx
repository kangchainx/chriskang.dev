      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12 flex flex-col items-center gap-6 text-center">
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          ...
          <Button
            variant="ghost"
            size="icon"
            className="rounded-full w-9 h-9 text-muted-foreground hover:bg-foreground hover:text-background transition-colors"
            asChild
          >
            <a
          ...
          <Button
            variant="ghost"
            size="icon"
            className="rounded-full w-9 h-9 text-muted-foreground hover:text-yellow-500 hover:bg-yellow-500/10 transition-colors"
            asChild
          >
            <a
